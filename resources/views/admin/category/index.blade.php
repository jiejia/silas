...
@section('content')
    <div class="block shadow" id="breadcrumb">
        <a href="{{ url('/admin') }}">首页</a> - <a href="{{ url('/admin/category') }}">分类</a> - <span>列表</span>
    </div>
...
@section('menu')
    ...
    <div class="menu-item" v-for="item in nav">
        ...
        <ul class="sub-menu">
            ...
            <li v-if="item.open_category"><a :href="'{{ url('/admin/category_') }}' + item.table_name" class="active">分类</a></li>
        </ul>
    </div>
    @else
    <div class="menu-item">
    ...
    <div class="menu-item">
        ...
        <ul class="sub-menu">
            <li><a href="{{ url('/admin/category') }}" class="active">列表</a></li>
...
<script type="text/javascript">
    $(function(){
        ...
        vm.getList('{{ url('/api/admin/category_' . $model . '/list')}}')
    })
</script>
@endsection
@section('methods')
